...
static const flex_int16_t yy_accept[24] =
    {   0,
        0,    0,   16,   14,   12,   13,   13,    1,    2,    7,
        5,    6,    8,    4,   10,   11,    9,    3,   12,   13,
        4,    3,    0
    } ;
...
static const flex_int16_t yy_base[24] =
    {   0,
        0,    0,   30,   31,   27,   13,   15,   31,   31,   31,
       31,   31,   31,   17,   31,   31,   31,    9,   24,   18,
       14,   12,   31
    } ;
...
static const flex_int16_t yy_nxt[47] =
    {   0,
       ...
       14,   15,   16,   17,   18,   20,   20,   20,   20,   22,
       20,   20,   22,   22,   21,   19,   22,   21,   19,   23,
...
{
    fprintf(stderr, "Error: Token Invalido '%s'\n", yytext);
}
	YY_BREAK
case 15:
YY_RULE_SETUP
